...
void MainWindow::on_actionupload_triggered()
{
    ...
    cv::resize(imaggrey, imaggrey, Size(512, 512), 0, 0);
...
void MainWindow::on_actionupload_2nd_img_triggered()
{
    ...
    Mat imaggrey = img2->getImage("hyprid");
    cv::resize(imaggrey, imaggrey, Size(512, 512), 0, 0);

    showImg(imaggrey, ui->originalImg_freqfilters3, QImage::Format_Grayscale8, this->origWidth, this->origHeight);
}
